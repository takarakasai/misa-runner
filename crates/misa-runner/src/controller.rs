...
impl Controller {
    ...
    pub fn tick(
        ...
        match self.state {
            ...
            State::FlippingKnees => self.tick_knee_flip(cmd, dt),
        }
    ...
    fn plan_knee_flip(
    ...
    ) -> Result<(Vec<crate::pose::PoseStep>, Vec<[bool; 4]>, [nalgebra::Vector3<f64>; 4]), String> {
        ...
        Ok((steps, stances, next_offset))
    }

    fn tick_knee_flip(&mut self, cmd: &Intent, dt: f64) {
