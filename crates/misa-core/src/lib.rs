...
pub use intent::{GaitSelect, GaitTune, Intent, ModeRequest, Pilot, PoseSlot, Velocity, WbcRequest, GaitControllerRequest, KneeFlipStyleRequest, KneePatternRequest};
